...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("sportsquizapp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("sportsquizapp.security.DomainUserDetailsService", "createSpringSecurityUser");
