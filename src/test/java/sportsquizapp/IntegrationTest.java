...
import sportsquizapp.SportsQuizApp;
import sportsquizapp.config.AsyncSyncConfiguration;
import sportsquizapp.config.EmbeddedSQL;
...
@SpringBootTest(classes = { SportsQuizApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
